...
export default function Footer() {
  return (
    <div className="text-white absolute bottom-0 pb-4 pt-4">
        <ul className="list-none flex gap-10">
            <li><a target="_blank" rel="noopener noreferrer" href="https://www.github.com/mendacium-a11y/Shortify">Github</a></li>
